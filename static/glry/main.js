        ...
        t.exports = function (t, s, n) {
          ...
          function M() {
            ...
            if (((d = arguments), (c = this), (h = t), n)) {
              if (void 0 === m)
                return (function (t) {
                  return (l = t), (m = setTimeout(v, s)), g ? y(t) : u;
                })(h);
              if (x) return clearTimeout(m), (m = setTimeout(v, s)), y(h);
            }
            return void 0 === m && (m = setTimeout(v, s)), u;
          }
          return (
            (s = i(s) || 0),
            o(n) &&
  ...
  (n.n = (t) => {
    ...
    (() => {
      ...
      if (
        ...
        s &&
        (s.currentScript &&
          "SCRIPT" === s.currentScript.tagName.toUpperCase() &&
          (t = s.currentScript.src),
        !t)
      ) {
        var o = s.getElementsByTagName("script");
        if (o.length)
          for (var e = o.length - 1; e > -1 && (!t || !/^http(s?):/.test(t)); )
            t = o[e--].src;
      }
      if (!t)
        throw new Error(
    ...
    (() => {
      ...
      class u extends Array {
        ...
        add(t, s) {
          return s ? o(this, t, s) : o(this, this, t), this;
        }
        sub(t, s) {
          return s ? e(this, t, s) : e(this, this, t), this;
        }
        multiply(t) {
          var s, n, o;
          return (
        ...
        cross(t, s) {
          return s ? c(this, t, s) : c(this, this, t), this;
        }
        scale(t) {
        ...
        clone() {
          return new u(this[0], this[1], this[2]);
        }
        fromArray(t, s = 0) {
          return (
      ...
      class l {
        constructor({
          ...
          (this.dpr = o),
            ...
            (this.autoClear = u),
            (this.id = h++),
            2 === m && (this.gl = t.getContext("webgl2", l)),
            (this.isWebgl2 = !!this.gl),
            this.gl ||
              (this.gl =
                t.getContext("webgl", l) ||
                t.getContext("experimental-webgl", l)),
            ...
            e.forEach((e) => {
              e.program.transparent
                ...
                0 === e.renderOrder &&
                  e.program.depthTest &&
                  s &&
                  (e.worldMatrix.getTranslation(m),
                  m.applyMatrix4(s.projectionViewMatrix),
                  (e.zDepth = m.z));
            }),
      ...
      class x extends Array {
          ...
          return (
            (function (t, s) {
              let n = s[0],
                ...
                r = n * n + o * o + e * e + i * i,
                a = r ? 1 / r : 0;
              (t[0] = -n * a), (t[1] = -o * a), (t[2] = -e * a), (t[3] = i * a);
            })(this, t),
            this.onChange(),
            this
          );
        ...
        multiply(t, s) {
          return s ? g(this, t, s) : g(this, this, t), this.onChange(), this;
        }
        dot(t) {
          return (
            (n = t),
          ...
          return (
            (function (t, s) {
              ...
              if (o > 0)
                ...
                let e = (o + 1) % 3,
                  i = (o + 2) % 3;
                (n = Math.sqrt(s[3 * o + o] - s[3 * e + e] - s[3 * i + i] + 1)),
                  (t[o] = 0.5 * n),
                  (n = 0.5 / n),
      ...
      class v extends Array {
        ...
        multiply(t, s) {
          return s ? p(this, t, s) : p(this, this, t), this;
        }
        identity() {
          var t;
          return (
      ...
      class M extends Array {
        ...
        fromQuaternion(t, s = this.order) {
          return b.fromQuaternion(t), this.fromRotationMatrix(b, s);
        }
      }
      class E {
        constructor() {
      ...
      class F extends E {
        constructor(
          ...
          super(),
            ...
            (this.viewMatrix = new v()),
            (this.projectionViewMatrix = new v()),
            (this.worldPosition = new u()),
      ...
      class I {
        ...
        computeBoundingSphere(t) {
          ...
          for (let n = 0, o = t.length; n < o; n += 3)
            _.fromArray(t, n),
              (s = Math.max(s, this.bounds.center.squaredDistance(_)));
      ...
      class L extends I {
        constructor(
          ...
          L.buildPlane(f, u, m, h, s, n, 0, r, a),
            Object.assign(i, {
      ...
      const D = n.p + "30e5c860aeb19be878d365d0022c1c28.jpg",
        j = n.p + "2a466a9468dd55f353d6d1cdbe26e652.jpg",
        X = n.p + "0849520e661c98b329e51d946e56d410.jpg",
        G = n.p + "26bf8d0b87d385dc8c4973a33b6cbfaf.jpg",
        k = n.p + "7f4180c985ebabc8485ff69ae14bdcdd.jpg",
        V = n.p + "8fc86a14c785e2b6c25cf727215d5ab5.jpg",
        q = n.p + "43dc789914eaf207689d9cb6f455d116.jpg",
        W = n.p + "da8cecd55f5cecd389810356e78ff6ca.jpg",
        Y = n.p + "046c4e6a4d9afee84b47bbd491c844d9.jpg",
        $ = n.p + "6f0872f4a4b6c06bb014e6b32b578ff2.jpg",
        H = n.p + "a1710b67888160d9a8a89e708a261720.jpg",
        Z = n.p + "3338c61dd22a1e5dbf18491278ffb743.jpg",
        Q = new Uint8Array(4);
      function K(t) {
        return !(t & (t - 1));
      }
          ...
          if (
            ...
            if (
              ...
              this.generateMipmaps &&
                ...
                (K(this.image.width) && K(this.image.height))
          ...
          this.gl.renderer.currentProgram === this.id ||
            ...
            this.uniformLocations.forEach((t, n) => {
              ...
              if (
                ...
                return at(`Active uniform ${o} has not been supplied`);
              if (e && void 0 === e.value)
                return at(`${o} uniform is missing a value parameter`);
              if (e.value.texture)
                return (s += 1), e.value.update(s), et(this.gl, n.type, t, s);
              if (e.value.length && e.value[0].texture) {
                ...
                return (
                  ...
                  et(this.gl, n.type, t, o)
                );
              }
              et(this.gl, n.type, t, e.value);
            }),
            this.applyState(),
            t &&
      ...
      class ct extends Array {
        ...
        multiply(t, s) {
          return s ? dt(this, t, s) : dt(this, this, t), this;
        }
        identity() {
          var t;
          return (
        ...
        fromBasis(t, s, n) {
          return (
            this.set(t[0], t[1], t[2], s[0], s[1], s[2], n[0], n[1], n[2]), this
          );
        }
        inverse(t = this) {
          return (
      ...
      function gt(t) {
        ...
        return (
          s || console.warn(`Unable to convert hex string ${t} to rgb values`),
          [
            parseInt(s[1], 16) / 255,
            parseInt(s[2], 16) / 255,
            parseInt(s[3], 16) / 255,
      ...
      class pt extends Array {
        constructor(t) {
          return Array.isArray(t) ? super(...t) : super(...xt(...arguments));
        }
        get r() {
          return this[0];
        }
        ...
        set(t) {
          return Array.isArray(t) ? this.copy(t) : this.copy(xt(...arguments));
        }
        copy(t) {
              ...
              for (let t = 0; t < s.length; t++) {
                ...
                for (let t = 0; t < c.glyphs.length; t++) {
                  ...
                  let m = s.x / n,
                    ...
                    g = 1 - s.y / i,
                    p = s.height / i;
                  u.uv.set([m, g - p, m, g, m + h, g - p, m + h, g], 4 * d * 2),
                    (a += s.yoffset * l),
                    d++;
                }
                a -= e * r;
      ...
      const wt =
        ...
        Mt = n.p + "c4170d08dcd3267f4d4c10c3c3f8364e.png",
        Et = class {
          ...
          createShader() {
            const t = new tt(this.gl, { generateMipmaps: !1 }),
              s = new Image();
            (s.src = Mt), (s.onload = (n) => (t.image = s));
            const n = `#version 300 es\n\n      #define attribute in\n      #define varying out\n\n      ${vt}\n    `,
              o = `#version 300 es\n\n      precision highp float;\n\n      #define varying in\n      #define texture2D texture\n      #define gl_FragColor FragColor\n\n      out vec4 FragColor;\n\n      ${wt}\n    `;
            let e = `\n      #extension GL_OES_standard_derivatives : enable\n\n      precision highp float;\n\n      ${wt}\n    `,
              i = `${vt}`;
            this.renderer.isWebgl2 && ((e = o), (i = n)),
              (this.program = new ot(this.gl, {
                cullFace: null,
                depthTest: !1,
                depthWrite: !1,
                transparent: !0,
          ...
          createMesh() {
            ...
            s.computeBoundingBox(),
              (this.mesh = new ut(this.gl, {
                geometry: s,
                program: this.program,
              })),
              (this.mesh.position.y = 0.5 * -this.plane.scale.y - 0.03),
        ...
        St = n.p + "0bbe7191e25aa7960588ce2dfdedf36c.png",
        Tt = class {
          constructor({ gl: t, plane: s, renderer: n, text: o }) {
            ht()(this),
              (this.gl = t),
          ...
          createMesh() {
            ...
            s.computeBoundingBox(),
              ...
              (this.mesh.position.y = 0.5 * -this.plane.scale.y - 0.085),
              this.mesh.setParent(this.plane);
          }
        },
        Ft = class {
          ...
          update(t, s) {
            (this.plane.position.x = this.x - t.current - this.extra),
              (this.plane.position.y =
                ...
                74.5),
              (this.plane.rotation.z = (function (t, s, n, o, e, i = !1) {
        ...
        _t = class {
          constructor({ gl: t, scene: s, viewport: n }) {
            ...
            const o = new L(this.gl),
              e = new ot(this.gl, {
                vertex:
                  "#define GLSLIFY 1\nattribute vec3 position;\nattribute vec3 normal;\n\nuniform mat4 modelViewMatrix;\nuniform mat4 projectionMatrix;\nuniform mat3 normalMatrix;\n\nvoid main() {\n  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);\n}\n\n",
                fragment:
                  "precision highp float;\n#define GLSLIFY 1\n\nuniform float uAlpha;\nuniform vec3 uColor;\n\nvoid main() {\n  gl_FragColor.rgb = uColor;\n  gl_FragColor.a = 1.0;\n}\n",
                uniforms: { uColor: { value: new pt("#c4c3b6") } },
                transparent: !0,
              });
            this.meshes = [];
            for (let t = 0; t < 50; t++) {
              let t = new ut(this.gl, { geometry: o, program: e });
              const s = z(0.75, 1);
              (t.scale.x = 1.6 * s),
                (t.scale.y = 0.9 * s),
                (t.speed = z(0.75, 1)),
                (t.xExtra = 0),
                (t.x = t.position.x =
                  z(0.5 * -this.viewport.width, 0.5 * this.viewport.width)),
                (t.y = t.position.y =
                  z(0.5 * -this.viewport.height, 0.5 * this.viewport.height)),
                this.meshes.push(t),
      ...
      new (class {
        constructor() {
          document.documentElement.classList.remove("no-js"),
            ...
            (this.onCheckDebounce = B()(this.onCheck, 200)),
            this.createRenderer(),
            this.createCamera(),
            this.createScene(),
            this.onResize(),
        ...
        createGeometry() {
          this.planeGeometry = new L(this.gl, {
            heightSegments: 50,
            widthSegments: 100,
          });
        }
        createMedias() {
          (this.mediasImages = [
            { image: D, text: "Natural Looking Veneers" },
            { image: j, text: "Smile rejuvination" },
            { image: X, text: "Implants" },
            { image: G, text: "Oral Care" },
            { image: k, text: "Natural Smile Design" },
            { image: V, text: "Full Set Crowns" },
            { image: q, text: "Mouth Restoration" },
            { image: W, text: "Bright Smile" },
            { image: Y, text: "Smile Design" },
            { image: $, text: "implants & Full set" },
            { image: H, text: "Shine Bright" },
            { image: Z, text: "Contact Us Today!" },
            { image: D, text: "Natural Looking Veneers" },
            { image: j, text: "Smile rejuvination" },
            { image: X, text: "Implants" },
            { image: G, text: "Oral Care" },
